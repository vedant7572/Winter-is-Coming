...
import 'package:winteriscoming/components/weather_item.dart';
import 'package:winteriscoming/constants.dart';
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                MainAxisAlignment.center,
                                                children: [
                                                  Image.asset('assets/' + getForecastWeather(2)["weatherIcon"],
                                                    width: 30,
                                                  ),
                                                  const SizedBox(
                                                    width: 5,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                MainAxisAlignment.center,
                                                children: [
                                                  Image.asset('assets/' + getForecastWeather(3)["weatherIcon"],
                                                    width: 30,
                                                  ),
                                                  const SizedBox(
                                                    width: 5,
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    getForecastWeather(3)["chanceOfRain"].toString() + "%",
                                                    style: const TextStyle(
                                                      fontSize: 18,
                                                      color: Colors.grey,
                                                    ),
